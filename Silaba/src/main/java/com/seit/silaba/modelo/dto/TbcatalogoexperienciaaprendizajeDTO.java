...
*
*/
public class TbcatalogoexperienciaaprendizajeDTO implements Serializable {
    private static final long serialVersionUID = 1L;
    private static final Logger log = LoggerFactory.getLogger(TbcatalogoexperienciaaprendizajeDTO.class);
