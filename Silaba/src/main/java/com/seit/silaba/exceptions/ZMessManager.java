package com.seit.silaba.exceptions;
...
public class ZMessManager extends RuntimeException {
	...
	public static String ENTITY_SUCCESFULLYSAVED = "Se grabo exitosamente";
	public static String ENTITY_SUCCESFULLYDELETED = "Se elimino exitosamente";
	public static String ENTITY_SUCCESFULLYMODIFIED = "Se modifico exitosamente";
